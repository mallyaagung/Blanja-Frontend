        ...
        <div className=" py-5" id="custom-cards">
          ...
          <div className="row row-cols-2 row-cols-lg-5 align-items-center g-5">
            <div className="col categories">
              <div className="card-category card-1 text-center d-flex flex-colum">
            ...
            <div className="col categories">
              <div className="card-category card-2 text-center d-flex flex-colum">
                <div className="card-body m-2">
            ...
            <div className="col categories">
              <div className="card-category card-3 text-center d-flex flex-colum">
                <div className="card-body m-2">
            ...
            <div className="col categories">
              <div className="card-category card-4 text-center d-flex flex-colum">
                <div className="card-body m-2">
            ...
            <div className="col categories">
              <div className="card-category card-5 text-center d-flex flex-colum">
                <div className="card-body m-2">
